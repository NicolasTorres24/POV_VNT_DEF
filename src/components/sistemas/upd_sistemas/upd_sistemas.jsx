      ...
      <div className="bg-black/5 p-6 rounded-lg shadow-lg w-full max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-[200px,1fr] gap-4 items-center">
            ...
            type="number"
            name="id_sistema"
            value={formData.id_sistema || 1} // Valor predeterminado como 1 si formData.id_sistema no está definido
            readOnly
            className="border border-black/20 rounded-md px-3 py-2 bg-gray-200 focus:outline-none cursor-not-allowed"
            />
